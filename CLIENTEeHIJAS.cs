// Proyecto Final POO Clase Padre e Hijas: Cliente , ClienteNatural y ClienteEmpresarial
...
namespace EcommercePipeline.Dominio{
    ...
    {
        public ClienteNatural(string id , string nombre , string email , string ciudad) : base(id , nombre , email , ciudad)
        {
    ...
    {
        public ClienteEmpresarial(string id , string nombre , string email , string ciudad) : base(id , nombre , email, ciudad)
        {
